...
def grouperMS(file, iza=False):

    if iza:
        print('Aktivovaný IZA mód, priraďujú sa všetky teoreticky možné MS aj pre neúplné HP.')
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Funkcia na priraďovanie hospitalizačných prípadov do medicínskych služieb.')
    parser.add_argument('data_path', action='store', help='Relatívna cesta k súboru s dátami.')
    parser.add_argument('--iza', action='store_true', help='Pracuj v tzv. IZA móde, snaž sa priradiť všetky teoreticky možné MS aj pre neúplné HP.')

    args = parser.parse_args()

    grouperMS(args.data_path, args.iza)
